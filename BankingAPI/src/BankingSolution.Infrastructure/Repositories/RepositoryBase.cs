...
using BankingSolution.Application.Specifications;
using BankingSolution.Infrastructure.Persistence;
using BankingSolution.Infrastructure.Specification;
...
namespace BankingSolution.Infrastructure.Repositories
{
    ...
    {
        protected readonly BankingSolutionDbContext _context;
        public RepositoryBase(BankingSolutionDbContext context)
        {
            _context = context;
        }
